    ...
    return (
        <div className="min-h-screen pt-32 pb-16">
            <div className="container mx-auto max-w-7xl px-4">
                    ...
                    <div className="mb-12">
                        ...
                        <div className="grid gap-8 md:grid-cols-2">
                            <div className="rounded-xl bg-davinci-dark-light border border-davinci-gold/20 p-6">
                                <h4 className="mb-4 text-xl font-semibold text-davinci-gold">Butler Style</h4>
                            ...
                            <div className="rounded-xl bg-davinci-dark-light border border-davinci-gold/20 p-6">
                                <h4 className="mb-4 text-xl font-semibold text-davinci-gold">Options Available</h4>
                    ...
                    <div className="overflow-hidden rounded-2xl premium-card">
                        <div className="grid md:grid-cols-2">
                            <div className="relative h-64 min-h-[400px] md:h-full">
                                <Image src="/assets/images/menus/italian/soup-risotto.jpg" alt="Soup & Risotto" fill className="object-cover" />
                ...
                {/* Pasta Section */}
                <MenuSectionCard
                    imageSrc="/assets/images/menus/italian/pasta.jpg"
                    imageAlt="Pasta"
                    title="Pasta"
                >
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div
                                        key={item}
                                        className="border-b border-gray-600 py-2 text-xl leading-relaxed text-gray-300"
                                    >
                                        • {item}
                                    </div>
                                ))}
                ...
                {/* Entree Section */}
                <MenuSectionCard
                    imageSrc="/assets/images/menus/italian/entree.jpg"
                    imageAlt="Entree"
                    title="Entree"
                >
                    ...
                    <div className="mb-8">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="rounded-xl bg-davinci-dark-light border border-davinci-gold/20 p-6 md:col-span-2">
                                <p className="text-lg leading-relaxed text-gray-300">
                    ...
                    <div className="overflow-hidden rounded-2xl premium-card">
                        <div className="grid md:grid-cols-2">
                            <div className="order-2 p-8 md:order-1 md:p-12">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="rounded-xl bg-davinci-dark-light border border-davinci-gold/20 p-4">
                            ...
                            <div className="relative order-1 h-64 min-h-[600px] md:order-2 md:h-full">
                                <Image src="/assets/images/menus/italian/desserts.jpg" alt="Desserts" fill className="object-cover" />
                                <div className="absolute inset-0 flex items-center justify-center bg-linear-to-br from-davinci-gold/85 to-davinci-gold-light/85 p-8">
