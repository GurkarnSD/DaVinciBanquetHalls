 ...
 * 1. Add your images to: public/assets/images/gallery/
 * 2. Add the image paths below (in alphabetical order recommended)
 * 3. Save this file
 *
 * The gallery will automatically use these images.
 */
